...
namespace TokenCrawler
{
    ...
    [CommandLineManager(ApplicationName = "\nToken Crawler",
        Copyright = " @Tiago Andrade e Silva\nThis utility crawls websites and searches for specific patterns in the HMTL and the js files used by the site(s).\nCheck http://tokencrawler.codeplex.com.\nRun TokenCrawler /help for options.",
